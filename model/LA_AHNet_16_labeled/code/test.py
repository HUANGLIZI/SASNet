...
parser.add_argument('--exp', type=str,  default='SDHNet', help='exp_name')
...
test_save_path = FLAGS.root_path + "model/{}_{}_{}_labeled/predictions/".format(FLAGS.dataset_name, FLAGS.exp, FLAGS.labelnum)
...
if FLAGS.dataset_name == "LA":
    ...
    patch_size = (96, 96, 96)
    FLAGS.root_path = './data/Pancreas_CT'
    with open(FLAGS.root_path + '/test.list', 'r') as f:
        image_list = f.readlines()
...
def test_calculate_metric():
    net =SASNet(n_channels=1, n_classes=2, normalization='batchnorm', has_dropout=False).cuda()
